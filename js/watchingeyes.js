...
pic0=new Image();
pic0.src = "/wp-content/plugins/theme-tricks/images/eye.gif";
pic1=new Image();
pic1.src = "/wp-content/plugins/theme-tricks/images/pupils.gif";
...
var _s=(n4)?'':'.style';
if (n4){
	document.write('<layer name="eyeball" top=0 left=0 width="69" height="34"><img src="/wp-content/plugins/theme-tricks/images/eye.gif" width="69" height="34"></layer>');
	document.write('<layer name="pupil1" top=0 left=0 width="13" height="13"><img src="/wp-content/plugins/theme-tricks/images/pupils.gif" width="13" height="13"></layer>');
	document.write('<layer name="pupil2" top:0 left=0 width="13" height="13"><img src="/wp-content/plugins/theme-tricks/images/pupils.gif" width="13" height="13"></layer>');
}
else{
if (ie)
document.write('<div id="ic" style="position:absolute;top:0;left:0"><div style="position:relative">');
document.write('<div id="eyeball" style="position:absolute;top:100px;left:100px;width:69px;height:34px"><img src="/wp-content/plugins/theme-tricks/images/eye.gif" width="69" height="34"></div>');
document.write('<div id="pupil1" style="position:absolute;top:0px;left:0px;width:12px;height:13px"><img src="/wp-content/plugins/theme-tricks/images/pupils.gif" width="13" height="13"></div>');
document.write('<div id="pupil2" style="position:absolute;top:0px;left:0px;width:12px;height:13px"><img src="/wp-content/plugins/theme-tricks/images/pupils.gif" width="13" height="13"></div>');
if (ie)
